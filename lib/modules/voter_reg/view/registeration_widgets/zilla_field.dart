...
class ZillaField extends StatefulWidget {
  const ZillaField({super.key, required this.voterRegBloc});
  final VoterRegBloc voterRegBloc;

  @override
  State<ZillaField> createState() => ZillaFieldState();
}

class ZillaFieldState extends State<ZillaField> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<String?>(
        stream: widget.voterRegBloc.zilla(context),
              ...
              children: [
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text:
                              "Zilla", //AppLocalizations.of(context)!.netWeightQTLStr,
                          style: TextStyle(
                            color:
                ...
                Padding(
                  padding:
                      EdgeInsets.only(left: context.mediaQueryWidth * 0.025),
                  child: InputField(
                    onChanged: widget.voterRegBloc.changeZilla,
                    textEditingController:
                        widget.voterRegBloc.zillaController,
                    hintText:
                        "Enter Zilla", //AppLocalizations.of(context)!.loginMobileHintStr,
